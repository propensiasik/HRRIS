...
--
-- Host: 127.0.0.1
-- Generation Time: 10 Apr 2016 pada 18.46
-- Versi Server: 5.6.16
-- PHP Version: 5.5.11
...
CREATE TABLE IF NOT EXISTS `available_schedule` (
  ...
  UNIQUE KEY `id_job_vacant` (`id_job_vacant`,`email_users`,`available_date`),
...
INSERT INTO `available_schedule` (`id_av_schedule`, `available_date`, `notes`, `email_users`, `is_used`, `id_job_vacant`) VALUES
('AS01', '2016-03-26', 'lala', 'khalilahunafa@gmail.com', 0, 'JV01'),
('AS02', '2016-03-24', 'lili', 'anestanggang@gmail.com', 0, 'JV01'),
('AS03', '2016-03-24', 'lulu', 'khalilahunafa@gmail.com', 0, 'JV03'),
('AS04', '2016-03-24', '', 'nabilaclydea@gmail.com', 0, 'JV01'),
('AS05', '2016-03-26', '', 'anestanggang@gmail.com', 0, 'JV03');
...
CREATE TABLE IF NOT EXISTS `interview` (
  ...
  `waktu_wawancara` time NOT NULL,
  `cara_wawancara` varchar(70) DEFAULT NULL,
  `notes` text,
  `id_applicant` char(10) NOT NULL,
  PRIMARY KEY (`id_wawancara`),
  UNIQUE KEY `id_applicant` (`id_applicant`,`tgl_wawancara`,`waktu_wawancara`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `interview` (`id_wawancara`, `tgl_wawancara`, `waktu_wawancara`, `cara_wawancara`, `notes`, `id_applicant`) VALUES
('IN01', '2016-03-29', '13:00:00', 'Tatap Muka', '', 'APP06'),
('IN02', '2016-03-30', '10:00:00', 'Telepon', '', 'APP07'),
('IN03', '2016-03-30', '13:00:00', 'Skype', '', 'APP08'),
('IN04', '2016-03-31', '10:00:00', 'Tatap Muka', '', 'APP09'),
('IN05', '2016-03-31', '13:45:00', 'Tatap Muka', '', 'APP10'),
('IN06', '2016-04-04', '11:00:00', 'Tatap Muka', '', 'APP09'),
('IN07', '2016-04-04', '14:00:00', 'Tatap Muka', '', 'APP10');
...
('IN02', 'anestanggang@gmail.com'),
('IN04', 'khalilahunafa@gmail.com'),
('IN02', 'nabilaclydea@gmail.com');
...
CREATE TABLE IF NOT EXISTS `status_applicant` (
  `id_applicant_status` char(10) NOT NULL,
...
('SA01', '2016-03-24', '2016-03-24', 'SLA01', 'S01', 'APP01', 'JV01'),
('SA02', '2016-03-24', '2016-03-24', 'SLA01', 'S01', 'APP02', 'JV02'),
('SA03', '2016-03-24', '2016-03-24', 'SLA01', 'S01', 'APP03', 'JV03'),
('SA04', '2016-03-25', '2016-03-25', 'SLA01', 'S01', 'APP04', 'JV05'),
('SA05', '2016-03-25', '2016-03-25', 'SLA01', 'S01', 'APP05', 'JV01'),
('SA06', '2016-03-25', '2016-03-25', 'SLA01', 'S01', 'APP06', 'JV02'),
('SA07', '2016-03-26', '2016-03-26', 'SLA01', 'S01', 'APP07', 'JV03'),
('SA08', '2016-03-26', '2016-03-26', 'SLA01', 'S01', 'APP08', 'JV05'),
('SA09', '2016-03-27', '2016-03-27', 'SLA01', 'S01', 'APP09', 'JV01'),
('SA10', '2016-03-27', '2016-03-27', 'SLA01', 'S01', 'APP10', 'JV02'),
('SA11', '2016-03-25', '2016-03-27', 'SLA02', 'S02', 'APP01', 'JV01'),
('SA12', '2016-03-25', '2016-03-27', 'SLA02', 'S02', 'APP02', 'JV02'),
('SA13', '2016-03-25', '2016-03-27', 'SLA02', 'S02', 'APP03', 'JV03'),
('SA14', '2016-03-26', '2016-03-28', 'SLA02', 'S02', 'APP04', 'JV05'),
('SA15', '2016-03-26', '2016-03-28', 'SLA02', 'S02', 'APP05', 'JV01'),
('SA16', '2016-03-26', '2016-03-28', 'SLA02', 'S03', 'APP06', 'JV02'),
('SA17', '2016-03-27', '2016-03-29', 'SLA02', 'S03', 'APP07', 'JV03'),
('SA18', '2016-03-27', '2016-03-29', 'SLA02', 'S03', 'APP08', 'JV05'),
('SA19', '2016-03-28', '2016-03-30', 'SLA02', 'S03', 'APP09', 'JV01'),
('SA20', '2016-03-28', '2016-03-30', 'SLA02', 'S03', 'APP10', 'JV02'),
('SA21', '2016-03-29', '2016-03-31', 'SLA03', 'S02', 'APP06', 'JV02'),
('SA22', '2016-03-30', '2016-04-01', 'SLA03', 'S02', 'APP07', 'JV03'),
('SA23', '2016-03-30', '2016-04-01', 'SLA03', 'S02', 'APP08', 'JV05'),
('SA24', '2016-03-31', '2016-04-02', 'SLA03', 'S04', 'APP09', 'JV01'),
('SA25', '2016-03-31', '2016-04-02', 'SLA03', 'S04', 'APP10', 'JV02');
