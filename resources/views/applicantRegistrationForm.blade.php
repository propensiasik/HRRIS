 ...
 <form action="Registration/Save" method="post" autocomplete="on" enctype="multipart/form-data">
  ...
  <div class="row margin">
    <div class="form-group"> 
      ...
      <div class="col-md-9"><input type="text" name="nama" autofocus placeholder=" Your Name " class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group"> 
      ...
      <div class="col-md-9"><input type="email" name="email" placeholder=" example@mail.com " class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group"> 
      ...
      <div class="col-md-9"><textarea name="alamat" placeholder="Street, home number, city" class="form-control"></textarea></div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group">  
      ...
      <div class="col-md-9"><input type="tel" name="phone" placeholder="08xxxxxxxxxx" class="form-control"></div>
    </div>
  </div>
  ...
  <div class="row-margin">
    <div class="form-group">  
      ...
      <div class="col-md-9"><input type="text" name="jurusan" placeholder="Your Major" class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group">
      ...
      <div class="col-md-9"><input type="text" name="universitas" placeholder="University " class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group">  
      ...
      <div class="col-md-9"><input type="text" name="tahunLulus" placeholder="20xx" class="form-control"></div>
    </div>
  </div>
  ...
  <div class="row margin">
    <div class="form-group">  
      ...
      <div class="col-md-9"><input type="number" name="ipk" min="0" max="4" step="0.01" placeholder="3,51" class="form-control"></div>
    </div>
  </div>
