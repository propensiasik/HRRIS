...
<h1 style="text-align: center"> Create Available Position </h1>
          ...
          <div class="table-responsive">
                <table class="table" style="margin-left:25%; margin-right:15%;">	
                  <tbody>
                    ...
                    <td><input type="text" name="posisi" autofocus required placeholder=" Name of the position "></td>
                	</tr>
                	<tr>
                    ...
                    <td><input type="number" name="jml_kebutuhan" min="1" step="1" placeholder= "1" required></td>
                	</tr>	
                  </tbody>
                </table>
                <div>
                  <div><label>Job Description<span></span></label></div>
                  <div><textarea name="description" placeholder= "o>description 1" required></textarea></div>
                </div>
                <br>
                <div>
                  <div><label>Job Requirement<span></span></label></div>
                  <div><textarea name="requirement" placeholder= "o>requirement 1" required></textarea></div>
                </div>
                <div>
